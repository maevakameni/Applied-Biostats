...
summary(data, digits = 2) %>%
  kableExtra::kbl(col.names = c("State postal abbreviation", "Degree of conflict", "Degree of unionization", "Union shop dummy", "Sector", "Ag force"),
...
Since there are some outliers, we will try to fit the model with or without them to access if these are influential points.

```{r, echo=FALSE}
#See if it is skewed or short-/long- tails
barplot(data$Degree_of_conflict, xlab = "Degree of conflict", ylab = "Value", main = "Barplot of the degree of conflict")
```
